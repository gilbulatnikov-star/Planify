  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <button
          onClick={onClose}
          className="absolute top-4 left-4 p-1.5 rounded-full hover:bg-[#2563eb]/10 text-muted-foreground hover:text-[#2563eb] transition-colors"
        >
          <X className="h-4 w-4" />
        </button>
        ...
        <div className="flex justify-center mb-4">
          <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#2563eb] shadow-lg">
        ...
        <Button
          ...
          className="w-full bg-[#2563eb] text-white hover:bg-[#2563eb]/90 rounded-xl py-3 text-sm font-bold flex items-center justify-center gap-2"
        >
